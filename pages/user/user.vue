...
<template>
	<view class="userLayout pageBg" v-if="userinfo">
		...
		<view class="section">
			<view class="list">
				<view url="/pages/classlist/classlist?name=我的下载&type=download" class="row">
					<view class="left">
				...
				<view url="/pages/classlist/classlist?name=我的评分&type=score" class="row">
					<view class="left">
				...
				<view class="row">
					...
					<!-- #ifdef MP -->
					<button open-type="contact" color="">联系客服</button>
					<!-- #endif -->
					<!-- #ifndef MP -->
		...
		<view class="section">
			<view class="list">
				<view url="/pages/notice/detail?id=653507c6466d417a3718e94b" class="row">
					<view class="left">
				...
				<view url="/pages/notice/detail?id=6536358ce0ec19c8d67fbe82" class="row">
					<view class="left">
